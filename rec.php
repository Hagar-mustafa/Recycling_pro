...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="centered" style="font-family: 'Rozha One' ; font-size: 130px ; color: white;">
        Recycling
      </div>
      <div class="centered" style="padding-top: 170px ; color:#c3c2be; font-size: 20px; font-family: 'Amaranth' ; ">Never refuse to reuse.</div>
      <div class="centered" style="padding-top: 214px ; color: #c3c2be; font-size: 20px ;font-family: 'Amaranth' ;">
                Save Your community, Save Your planet
      </div>
    </div>
    <div class="carousel-item">
      <img src="slide01.jpg" class="d-block w-100" alt="...">
      <div class="centered" style="font-family: 'Rozha One'; font-size: 95px ; color: white;"> 
               Save Your Planet
      </div>
      <div class="centered" style="padding-top: 170px ; color:#a6bd4f; font-size: 30px;font-family: 'Playfair Display SC' ; ">SAVE YOUR COMMUNITY</div>
      <div class="centered" style="padding-top: 250px ; color: #c3c2be; font-size: 24px ;font-family: 'Tulpen One' ;">
    ...
    <div class="carousel-item">
      ...
      <div class="centered" style="font-family: 'Rozha One' ; font-size: 130px ; color: white;">Recycling
      </div>
      <div class="centered" style="padding-top: 170px ; color:#c3c2be; font-size: 20px; font-family: 'Amaranth' ; ">Never refuse to reuse.</div>
      <div class="centered" style="padding-top: 214px ; color: #c3c2be; font-size: 20px ;font-family: 'Amaranth' ;">
                Save Your community, Save Your planet
    ...
    <div class="container mt-5" style="padding-top: 100px;">
      <div class="row">
        <div class="col-md-4 offset-md-4">
          ...
          <i class="fas fa-recycle fa-2x centered" style="color: #9CC026; padding-bottom: 210px"></i>
          <h3 style="text-align: center; font-family: 'DM Serif Display' ; font-size: 60px">Welcome to Rebekia</h3>
          <h6 style="text-align: center;">MORE ABOUT US</h6>
        ...
        ">
          <div class="col-md-6 offset-md-3">
            <p style="text-align: center; color: #acaea5;font-family: 'Delius' ;">
              Rebekia is a Family-owned company located in San Diego, California proudly serving individuals and businesses in Southern California with their computers and electronics upgrade needs, accepting computers and electronics waste in any conditions
            </p>
          </div>
        </div>
        <div class="row">
